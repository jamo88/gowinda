...
public class CdsDecorator implements IBulkAnnotationReader {

	private static String toFilter="cds";
	private Logger logger;
	private IBulkAnnotationReader bar;
	public CdsDecorator(IBulkAnnotationReader bar, Logger logger)
	{
		this.bar=bar;
		this.logger=logger;
	}
